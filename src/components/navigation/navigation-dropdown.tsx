...
function DropdownSection({ children, title }: IDropdownSectionProps) {
  return (
    <section>
...
export const NavigationDropdown: React.FunctionComponent<INavigationDropdown> = ({
  memoji,
}) => {
  return (
    <div className={styles.container}>
      <div className={styles.sectionContainer}>
        ...
        <DropdownSection title="Section 3">
          <DropdownItem />
          <DropdownItem />
          <DropdownItem />
        </DropdownSection>
      ...
      <div className={styles.memojiContainer}>
        ...
        <Image src={memoji.src} className="z-30" alt={memoji.alt} placeholder="blur" />
      </div>
    </div>
  );
};
